...
class LogTimesPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    _patrolDateController.text =  selectedPatrolDate!=null? DateFormat("yyyy-MM-dd").format(selectedPatrolDate!):'';
    ...
    _startedPatrolController.text = selectedStartedPatrol?.format(context) ?? '';

    TimeOfDay?  selectedCompletedPatrol = patrolTimeLog.completedPatrol;
    _selectedCompletedPatrolController.text = selectedCompletedPatrol?.format(context) ?? '';

    TimeOfDay?  selectedLeftPatrol = patrolTimeLog.leftPatrol??TimeOfDay.fromDateTime(DateTime.now());
    _selectedLeftPatrolController.text = selectedLeftPatrol?.format(context)??'';
                ...
                children: [
                  ...
                  ...[
                            ...
                            onPressed: () async {
                              selectedPatrolDate = await showDatePicker(
                                ...
                                _patrolDateController.text =
                                   selectedPatrolDate !=null? DateFormat("yyyy-MM-dd").format(selectedPatrolDate!) :'' ;
                    ...
                    FilledButton(onPressed: (){
                      ...
                      patrolTimeLog.completedPatrol = selectedCompletedPatrol;
                      ...
                      if(patrolTimeLog.patrolDate != null &&
                        ...
                        ref.read(patrolLogProvider.notifier).setPatrolTimeLog(
                            patrolTimeLog);
                        context.go('/weatherPage');
                      }else{
                        var snackbar = SnackBar(
                          content: const Text('At least one of the fields is missing'),
                          elevation: 16,
