        ...
        child: Scrollbar(
          child: SingleChildScrollView(
            ...
            child: AutofillGroup(
              ...
              subtitle: Text('Your log have been submitted successfully'),
            ),
              Row(
                  ...
                  const SizedBox(width: 8),
                    ...
                    FutureBuilder<PatrolLogLast10Response>(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.hasData) {
                          List<PatrolLogResponse> patrolLogsResponse = snapshot.data!.userPatrolLogs!;
                        return  Column(children:[
                                ...
                                child: ListView.separated(
                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                    return ListTile(
                                        ...
                                        title: Text(patrolLogsResponse[index].patrolNo.toString()),
                                        subtitle:  Text(patrolLogsResponse[index].created!),
                          ...
                          Row(children:[const SizedBox(width: 50,),Text('User Logs: ${snapshot.data!.userPatrolLogsCount.toString()}', style: const TextStyle(fontSize: 16, color: Colors.black54, fontWeight: FontWeight.bold),),const SizedBox(width: 50,),Text('Total Logs: ${snapshot.data!.patroLogsCount.toString()}', style: const TextStyle(fontSize: 16, color: Colors.black54, fontWeight: FontWeight.bold))]),
