                ...
                child: TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    FilledButton(onPressed: (){
                      ...
                      weatherLog.temperature = int.parse(_temperatureController.text);
                      weatherLog.wind = _windController.text;
                      weatherLog.cloudCover = _cloudCoverController.text;
                      weatherLog.humidity = int.parse(_humidityController.text);
                      weatherLog.comments = _commentsController.text;

                      if((weatherLog.wind?.isNotEmpty??false) && (weatherLog.cloudCover?.isNotEmpty??false)){
                      ref.read(patrolLogProvider.notifier).setWeatherLog(weatherLog);
...
class PercentInputFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(TextEditingValue oldValue,TextEditingValue newValue,) {
    ...
    return int.parse(newValue.text) > 100 ? const TextEditingValue().copyWith(text: '100') : newValue;
  }
}