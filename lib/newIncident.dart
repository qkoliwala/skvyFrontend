...
/// This class takes in the incidents that the users can face
/// during their patrol and store it as a Medical, Enforcement, and
/// others that can provide more details for further research.
...
class _NewIncidentPageState extends ConsumerState<NewIncidentPage> {
  ...
  final _types = ["Medical", "Enforcement", "Other"];
                  ...
                  ...[
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          onPressed: () {
                            IncidentReportLog incidentReport =
                                IncidentReportLog(
